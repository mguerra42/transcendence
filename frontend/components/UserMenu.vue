...
<template>
    <div  class="absolute top-100% right-0 bg-white text-dark min-w-160px  rounded-lb overflow-hidden z-500" >
        <ul>
            ...
            <li class="" v-if="auth.session?.username">
                ...
                }" class="flex items-center gap-2 b-t-1 select-none hover:bg-gray-200 hover:text-gray-800 px-3 py-2 cursor-pointer">
