...
<template>
    <div class="w-80 bg-white p-6 rounded-lg relative">
        <h1 class="text-gray text-2xl mb-6">2FA verification</h1>
            <input type="password" v-model="twoFA" autocomplete="false" name="twoFA" placeholder="2FA Code" class="rounded-lg w-full  mb-4 px-3 py-2 text-black b-1 " style="font-family : terminal"/>
