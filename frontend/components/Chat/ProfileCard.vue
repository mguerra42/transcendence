...
<template>
	<div  class="rounded-lg b-1 overflow-hidden">
		...
		<div class="flex flex-row sm:flex-col md:flex-row items-center justify-center w-full" v-if="user.user.id != auth.session.id">
			<div class="flex-1 hover:bg-white w-full hover:text-gray-700 cursor-pointer flex items-center px-2 gap-2 justify-center py-1 b-t-1 b-r-1 md:b-r-1  sm:b-r-0">
				<div class="i-mdi:user"></div>
				Add </div>
			<div class="flex-1 hover:bg-white w-full hover:text-gray-700 cursor-pointer flex items-center px-2 gap-2 justify-center py-1  b-t-1 " >
				<div class="i-mdi:trophy"></div>
				Challenge</div>
			<div  class="flex-1 hover:bg-white w-full hover:text-gray-700 cursor-pointer flex items-center px-2 gap-2 justify-center py-1  b-t-1  b-l-1 md:b-l-1 sm:b-l-0">
